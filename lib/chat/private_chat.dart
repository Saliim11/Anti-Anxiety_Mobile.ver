      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              String contact = await _getContactFromFirestore();
              print(contact);
            ...
            //     final kontak = userData['kontak'] as String?;
            //     if (kontak != null) {
            //       setState(() {
            //         no_telpon = kontak;
            //       });
            //       FlutterPhoneDirectCaller.callNumber(no_telpon);
            //     } else {
